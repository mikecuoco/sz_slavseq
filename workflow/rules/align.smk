...
rule bwa_mem:
    ...
    output: "results/bwa_mem/{donor}_{dna_type}/{sample}.bam"
    log: "results/bwa_mem/{donor}_{dna_type}/{sample}.log"
    params: 
        extra="-T 19",
        sorting="samtools"
    threads: 4
...
rule rmdup:
    ...
    output: "results/rmdup/{donor}_{dna_type}/{sample}.bam"
    log: "results/rmdup/{donor}_{dna_type}/{sample}.log"
    conda: "../envs/env.yml"
    shell:
        "workflow/scripts/slavseq_rmdup_hts.py {input} {output} > {log} 2>&1"
...
rule tags:
    ...
    output: "results/tags/{donor}_{dna_type}/{sample}.bam"
    log: "results/tags/{donor}_{dna_type}/{sample}.err"
    conda: "../envs/env.yml"
    shell:
        '''
        # set inputs
...
rule tabix:
    ...
    output: 
        bgz = "results/tabix/{donor}_{dna_type}/{sample}.bgz",
        tbi = "results/tabix/{donor}_{dna_type}/{sample}.bgz.tbi"
    log: "results/tabix/{donor}_{dna_type}/{sample}.log"
    conda: "../envs/env.yml"
    shell:
        '''
        samtools view {input} | \
