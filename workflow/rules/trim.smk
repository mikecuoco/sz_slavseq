rule cutadapt1:
    input:
        get_cutadapt_input,
    output:
        fastq1="{outdir}/results/trim/cutadapt1/{donor}/{dna_type}/{sample}_R1.fastq.gz",
        fastq2="{outdir}/results/trim/cutadapt1/{donor}/{dna_type}/{sample}_R2.fastq.gz",
        qc="{outdir}/results/trim/cutadapt1/{donor}/{dna_type}/{sample}_qc.txt",
    params:
    ...
    log:
        "{outdir}/results/trim/cutadapt1/{donor}/{dna_type}/{sample}.log",
    threads: 2
    wrapper:
...
rule cutadapt2:
    ...
    output:
        fastq1="{outdir}/results/trim/cutadapt2/{donor}/{dna_type}/{sample}_R1.fastq.gz",
        fastq2="{outdir}/results/trim/cutadapt2/{donor}/{dna_type}/{sample}_R2.fastq.gz",
        qc="{outdir}/results/trim/cutadapt2/{donor}/{dna_type}/{sample}_qc.txt",
    params:
