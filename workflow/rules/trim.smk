rule cutadapt1:
    ...
    output:
        fastq1="results/cutadapt1/{donor}_{dna_type}/{sample}_R1.fastq.gz",
        fastq2="results/cutadapt1/{donor}_{dna_type}/{sample}_R2.fastq.gz",
        qc="results/cutadapt1/{donor}_{dna_type}/{sample}_qc.txt"
    params:
    ...
    log: "results/cutadapt1/{donor}_{dna_type}/{sample}.log"
    threads: 4 
    conda: "../envs/env.yml"
    wrapper:
...
rule cutadapt2:
    ...
    output:
        fastq1="results/cutadapt2/{donor}_{dna_type}/{sample}_R1.fastq.gz",
        fastq2="results/cutadapt2/{donor}_{dna_type}/{sample}_R2.fastq.gz",
        qc="results/cutadapt2/{donor}_{dna_type}/{sample}_qc.txt"
    params:
        ...
        extra="--minimum-length=36 --quality-base=33 --quality-cutoff=28 --overlap=5 --times=4"
    log: "results/cutadapt2/{donor}_{dna_type}/{sample}.log"
    threads: 4 
    conda: "../envs/env.yml"
    wrapper:
        "v1.7.1/bio/cutadapt/pe"