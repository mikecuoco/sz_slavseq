rule get_features:
    ...
    log:
        "{outdir}/results/get_features/{ref}/{donor}/{dna_type}/{sample}.log",
    cache: True
    conda:
        "../envs/features.yml"
    script:
...
rule folds:
    ...
    output:
        ...
        label_encoder="{outdir}/results/folds/{ref}_{db}/{dna_type}/label_encoder.pickle",
    log:
        "{outdir}/results/folds/{ref}_{db}/{dna_type}.log",
    conda:
        "../envs/model.yml"
    script:
        "../scripts/folds.py"
...
rule train_test:
    ...
    log:
        "{outdir}/results/train_test/{ref}_{db}/{dna_type}/{model_id}.log",
    conda:
        "../envs/model.yml"
    script:
...
rule metrics:
    ...
    params:
        ...
        models=model_ids,
    output:
        prcurve="{outdir}/results/metrics/{ref}_{db}/{dna_type}/prcurve.svg",
    conda:
        "../envs/model.yml"
    log:
